 ...
 * (4) Lexical Analyzer class QuexParser and its memento class.
 * (5) Constructor and init core of QuexParser.
...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____QUEX____QUEXPARSER
#define __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____QUEX____QUEXPARSER
...
#   undef   __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____QUEXPARSER
#else
#   define  __QUEX_INCLUDE_INDICATOR__ANALYZER__MAIN
#endif
#define     __QUEX_SIGNAL_DEFINED_LEXER_IN_NAMESPACE___QUEX__

#include "QuexParser-configuration.hpp"
...
QUEX_NAMESPACE_MAIN_OPEN 
    ...
    class  QUEX_TYPE0_ANALYZER;    /* QuexParser */
...
#include "QuexParser-token_ids.hpp"
...
enum {
    ...
    QUEX_NAME(ModeID_Quotation) = 1
};

        extern QUEX_NAME(Mode)  QUEX_NAME(Program);
        extern QUEX_NAME(Mode)  QUEX_NAME(Quotation);
...
#endif
extern     __QUEX_TYPE_ANALYZER_RETURN_VALUE QUEX_NAME(Quotation_analyzer_function)(QUEX_TYPE_ANALYZER*);
extern     void QUEX_NAME(Quotation_on_exit)(QUEX_TYPE_ANALYZER*, const QUEX_NAME(Mode)*);
extern     void QUEX_NAME(Quotation_on_entry)(QUEX_TYPE_ANALYZER*, const QUEX_NAME(Mode)*);
#ifdef QUEX_OPTION_RUNTIME_MODE_TRANSITION_CHECK
extern     bool QUEX_NAME(Quotation_has_base)(const QUEX_NAME(Mode)*);
extern     bool QUEX_NAME(Quotation_has_entry_from)(const QUEX_NAME(Mode)*);
extern     bool QUEX_NAME(Quotation_has_exit_to)(const QUEX_NAME(Mode)*);
#endif
...
#   include <quex/code_base/analyzer/Engine_body>
    ...
    /* DISABLED */ QuexParser(const QuexParser&);
public:
    typedef QUEX_TYPE_TOKEN      token_type;
    typedef QUEX_TYPE_TOKEN_ID   token_id_type;
    typedef QUEX_TYPE_CHARACTER  char_type;

    QuexParser(QUEX_TYPE_CHARACTER* BufferMemoryBegin, size_t  BufferMemorySize,
               QUEX_TYPE_CHARACTER* BufferEndOfContentP   = 0x0,
               const char*          CharacterEncodingName = 0x0,
               bool                 ByteOrderReversionF   = false);
    QuexParser(const std::string&   Filename,       
               const char*          CharacterEncodingName = 0x0,
               bool                 ByteOrderReversionF   = false);
    QuexParser(std::istream*        p_input_stream, 
               const char*          CharacterEncodingName = 0x0,
               bool                 ByteOrderReversionF   = false);
#   if defined(__QUEX_OPTION_WCHAR_T)
    QuexParser(std::wistream*       p_input_stream,
               const char*          CharacterEncodingName = 0x0,
               bool                 ByteOrderReversionF   = false);
#   endif
    QuexParser(std::FILE*           input_fh,       
               const char*          CharacterEncodingName = 0x0,
               bool                 ByteOrderReversionF   = false);
#   if defined(__QUEX_OPTION_UNIT_TEST)
    template <class UnderlyingStreamT>
        QuexParser(quex::StrangeStream<UnderlyingStreamT>*  p_input_stream, 
                   const char*                              CharacterEncodingName = 0x0,
                   bool                                     ByteOrderReversionF   = false);
#   endif
...
#endif
    friend     __QUEX_TYPE_ANALYZER_RETURN_VALUE QUEX_NAME(Quotation_analyzer_function)(QUEX_TYPE_ANALYZER*);
    friend     void QUEX_NAME(Quotation_on_exit)(QUEX_TYPE_ANALYZER*, const QUEX_NAME(Mode)*);
    friend     void QUEX_NAME(Quotation_on_entry)(QUEX_TYPE_ANALYZER*, const QUEX_NAME(Mode)*);
#ifdef QUEX_OPTION_RUNTIME_MODE_TRANSITION_CHECK
    friend     bool QUEX_NAME(Quotation_has_base)(const QUEX_NAME(Mode)*);
    friend     bool QUEX_NAME(Quotation_has_entry_from)(const QUEX_NAME(Mode)*);
    friend     bool QUEX_NAME(Quotation_has_exit_to)(const QUEX_NAME(Mode)*);
#endif
...
#   line 61 "src/Parser/QuexParser.qx"

	int quote_depth;

#   line 364 "QuexParser.hpp"
                            ...
                            QUEX_TYPE_CHARACTER*   BufferEndOfFileP)
{
    ...
    __quex_assert(QUEX_NAME(ModeID_Quotation) < 2);
...
#    endif
     ...
     QUEX_NAME(Quotation).id   = QUEX_NAME(ModeID_Quotation);
     QUEX_NAME(Quotation).name = "Quotation";
     QUEX_NAME(Quotation).analyzer_function = QUEX_NAME(Quotation_analyzer_function);
#    if      defined(QUEX_OPTION_INDENTATION_TRIGGER) \
        && ! defined(QUEX_OPTION_INDENTATION_DEFAULT_HANDLER)
     QUEX_NAME(Quotation).on_indentation = QUEX_NAME(Mode_on_indentation_null_function);
#    endif
     QUEX_NAME(Quotation).on_entry       = QUEX_NAME(Quotation_on_entry);
     QUEX_NAME(Quotation).on_exit        = QUEX_NAME(Quotation_on_exit);
#    if      defined(QUEX_OPTION_RUNTIME_MODE_TRANSITION_CHECK)
     QUEX_NAME(Quotation).has_base       = QUEX_NAME(Quotation_has_base);
     QUEX_NAME(Quotation).has_entry_from = QUEX_NAME(Quotation_has_entry_from);
     QUEX_NAME(Quotation).has_exit_to    = QUEX_NAME(Quotation_has_exit_to);
#    endif
        me->mode_db[QUEX_NAME(ModeID_Program)]   = &(QUEX_NAME(Program));
        me->mode_db[QUEX_NAME(ModeID_Quotation)] = &(QUEX_NAME(Quotation));
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____QUEX____QUEXPARSER */
