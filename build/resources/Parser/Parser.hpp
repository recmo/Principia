 ...
 * (4) Lexical Analyzer class Parser and its memento class.
 * (5) Constructor and init core of Parser.
 * (6) Memento pack and unpack functions.
 *
 * File content generated by Quex 0.62.4.
 *
 * (C) 2005-2012 Frank-Rene Schaefer
 * ABSOLUTELY NO WARRANTY                                                      */
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____QUEX____PARSER
#define __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____QUEX____PARSER
...
#   undef   __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____PARSER
#else
...
QUEX_NAMESPACE_MAIN_OPEN 
    ...
    class  QUEX_TYPE0_ANALYZER;    /* Parser */
...
public:
    ...
    Parser(const std::string&   Filename,       
           const char*          CharacterEncodingName = 0x0,
           bool                 ByteOrderReversionF   = false);
    Parser(std::istream*        p_input_stream, 
           const char*          CharacterEncodingName = 0x0,
           bool                 ByteOrderReversionF   = false);
#   if defined(__QUEX_OPTION_WCHAR_T)
    Parser(std::wistream*       p_input_stream,
           const char*          CharacterEncodingName = 0x0,
           bool                 ByteOrderReversionF   = false);
#   endif
    Parser(std::FILE*           input_fh,       
           const char*          CharacterEncodingName = 0x0,
           bool                 ByteOrderReversionF   = false);
#   if defined(__QUEX_OPTION_UNIT_TEST)
    template <class UnderlyingStreamT>
        Parser(quex::StrangeStream<UnderlyingStreamT>*  p_input_stream, 
               const char*                              CharacterEncodingName = 0x0,
               bool                                     ByteOrderReversionF   = false);
#   endif
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____QUEX____PARSER */
