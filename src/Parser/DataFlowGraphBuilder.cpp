...
DataFlowGraphBuilder::DataFlowGraphBuilder(ParseTree* parseTree)
...
void DataFlowGraphBuilder::compile()
{
...
void DataFlowGraphBuilder::declare(ParseTree::Node* node)
{
...
void DataFlowGraphBuilder::connect(ParseTree::Node* node)
{
	assert(node);
	if(node->isA<ParseTree::Statement>()) {
		ParseTree::Statement* statement = node->to<ParseTree::Statement>();
